...
import com.team.MMSValleyBall.filter.LoginFilter;
import com.team.MMSValleyBall.jwt.JwtFilter;
import com.team.MMSValleyBall.jwt.JwtUtil;
...
public class SecurityConfig{
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        ...
        http.authorizeHttpRequests((auth) -> auth.requestMatchers(HttpMethod.OPTIONS, "/**").permitAll()
                .requestMatchers( "/main", "/login/**", "/signup/**","/game/**", "/admin/**").permitAll()
                .requestMatchers( "/ticket/**", "/myPage/**", "/membership/**").hasAnyRole("USER","ADMIN")
