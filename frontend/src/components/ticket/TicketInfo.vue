<template>
  <div class="ticket-info-page">
    ...
    <div class="ticket-info-content">
      ...
      <!-- 티켓 안내 페이지 내용2  -->
      <div>
        <h2>MMS 2024-2025시즌 V-리그 홈경기 권종 및 가격</h2>
      </div>

      <!-- 티켓 안내 가격 표  -->
      <div>
        <table class="ticket-info-price">
          <thead>
            <tr>
              <th>구분</th>
              <th>층</th>
          ...
          <tbody>
            <tr>
              ...
              <td>GA ~ GC</td>
              <td>90석</td>
              <td>21,000원 (골드 멤버십 할인 30% 적용)</td>
            </tr>
            <tr>
              <td>그레이(원정석) [AWAY ZONE]</td>
              <td>AA ~ AC</td>
              <td>90석</td>
              <td>30,000원</td>
            </tr>
      ...
      <div class="rule-box">
        <div>
          ...
          <div>
            - 1인 최대 4매까지 구매 가능<br>
            - 예매 오픈 시간 : 경기 7일 전 13시 시작<br>
            <div class="sub-text">
              * 멤버십 선예매는 경기 10일 전 13시 시작<br>
            </div>
            - 예매 가능 시간 : 경기 당일 경기 시작 시간 1시간 전 마감<br>
            - 현장 매표소 운영시간 : 경기 시작 2시간 전 시작 (변경 시 별도 공지)<br>
            <div class="sub-text">
          ...
          <div>
            <h3>※ 경기 당일 안내사항</h3>
            <div>
              - 경기 당일 매표소가 혼잡하오니, 모바일 티켓을 활용하여 편안한 입장을 권장 드립니다.<br>
              - 모바일 티켓은 바로 출입구에서 입장이 가능합니다.<br>
              - 모바일 티켓 캡처 혹은 이미지는 입장 불가 (앱에서 예약번호 혹은 바코드가 실시간으로 움직이는 티켓만 입장 가능)<br>
            </div>

            <div>
              <h3>※ 티켓 환불 규정</h3>
              <div>
                - 경기 시작 12시간 이내 취소 불가<br>
                - 경기 시작 24시간 이내 취소 50% 환불<br>
                - 경기 시작 48시간 이내 취소 70% 환불<br>
                - 경기 시작 72시간 이내 취소 100% 환불<br>
              </div>
            </div>
          </div>
        </div>
