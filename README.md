...
- **프론트엔드:** Vue.js, HTML, CSS, JavaScript, Thymeleaf

- **백엔드:** Java 17, Spring Boot, JPA
...
Git을 활용한 협업 역시 처음이었기 때문에, 개발뿐만 아니라 협업 과정 자체를 익히는 데에도 의미가 있었습니다.
...
경기 정보 CRUD를 구현하는 과정에서는 경기 변경 시 사용자 안내가 필요하다고 판단해 메일 발송 기능을 추가했습니다.

<br>

Vue 기반 사용자 페이지와 Thymeleaf 기반 관리자 페이지를 각각 구현하면서

CSR과 SSR의 차이, 그리고 상태 변화에 따라 화면이 구성되는 방식에 대해 고민해볼 수 있었습니다.

<br>

이번 프로젝트를 통해 기능 구현 외에도 함께 고려해야 할 부분이 많다는 점을 느낄 수 있었고,
